...
function WebAudioFontLoader(player) {
	...
	this.instrumentInfo = function(n) {
		...
		return {
            ...
            url: 'webaudiofont/webaudiofontdata/sound/' + key + '.js',
	...
	this.drumInfo = function(n) {
		...
		return {
			...
			url: 'webaudiofont/webaudiofontdata/sound/128' + key + '.js',
			pitch: p,
...
'use strict'
console.log('WebAudioFont Reverberator/Compressor v1.17 GPL3');
